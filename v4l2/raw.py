...
VIDIOC_QBUF                     = ioctl_macros.IOWR(ord('V'), 15, v4l2_buffer)
VIDIOC_DQBUF                    = ioctl_macros.IOWR(ord('V'), 17, v4l2_buffer)
VIDIOC_STREAMON                 = ioctl_macros.IOW(ord('V'), 18, ctypes.c_int)
VIDIOC_STREAMOFF                = ioctl_macros.IOW(ord('V'), 19, ctypes.c_int)
